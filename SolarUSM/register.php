...
if ($_POST) {
    if (isset($_POST['btn-registrar-contratista'])) {
        ...
        if (!empty($_POST["nombre_usuario"]) && !empty($_POST["clave_usuario"]) && !empty($_POST["correo_usuario"]) && !empty($_POST["fecha_nac"])) {
            ...
            //IMG 1
            $n_imagen1 = $_FILES["imagen1"]["name"];
            $archivo1 = $_FILES["imagen1"]["tmp_name"];

            $ruta1 = "./imagenes/" . $n_imagen1;
            $base_datos1 = "imagenes/" . $n_imagen1;

            move_uploaded_file($archivo1, $ruta1);

            //IMG 2
            $n_imagen2 = $_FILES["imagen2"]["name"];
            $archivo2 = $_FILES["imagen2"]["tmp_name"];

            $ruta2 = "./imagenes/" . $n_imagen2;
            $base_datos2 = "imagenes/" . $n_imagen2;
            ...
            if ($result->num_rows > 0 || $result2->num_rows > 0) {
                ...
                VALUES ('$nombre', '$fecha_nac', '$correo', '$clave', '$telefono', '$ciudad', '$direccion', '$fecha_ingreso', '$experiencia', '$detalle_experiencia', '$sistema_prevision', '$sistema_salud', '$jubilacion', '$detalle_jubilacion', '$base_datos1', '$base_datos2')";
        ...
        //IMG 3
        $n_imagen3 = $_FILES["foto1_licencia"]["name"];
        $archivo3 = $_FILES["foto1_licencia"]["tmp_name"];

        $ruta3 = "./imagenes/" . $n_imagen3;
        $base_datos3 = "imagenes/" . $n_imagen3;

        move_uploaded_file($archivo3, $ruta3);

        //IMG 4
        $n_imagen4 = $_FILES["foto2_licencia"]["name"];
        $archivo4 = $_FILES["foto2_licencia"]["tmp_name"];

        $ruta4 = "./imagenes/" . $n_imagen4;
        $base_datos4 = "imagenes/" . $n_imagen4;
    ...
    <div class="container">
        ...
        <h2>Registro de Temporero</h2>
            <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <input type="text" class="form-control" name="ciudad" placeholder="Escriba su ciudad" required>

                    <label for="direccion_usuario">Dirección:</label>
                    <input type="text" class="form-control" name="direccion" placeholder="Escriba su dirección" required>

                    <label for="sistema_prevision">Sistema de prevision:</label>
                    <input type="text" class="form-control" name="sistema_prevision" placeholder="Escriba el nombre de su sistema de previsión" required>

                    <label for="sistema_salud">Sistema de salud:</label>
                    <input type="text" class="form-control" name="sistema_salud" placeholder="Escriba el nombre de su sistema de salud" required>
                    ...
                    <input type="text" class="form-control" name="experiencia" placeholder="Escriba sus años de experiencia" required>
