...
<body>
    ...
    <form method="post">
        ...
        <div class="boton-container">
            <button class="boton" type="submit" name="button1">Seleccionar temporeros a mis ofertas</button>
        </div>
        <div class="boton-container">
            <button class="boton" type="submit" name="button6">Seleccionar transportistas a mis ofertas</button>
        </div>
    </form>
    ...
    if (isset($_POST['button1'])) {
        ...
        header("Location: seleccionPostulantes.php");
        exit();
        ...
        // Acción a realizar cuando se hace clic en Botón 2
        header("Location: seleccionPostulantest.php");
        exit();
    }
    ?>
</body>
