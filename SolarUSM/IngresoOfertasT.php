...
if (isset($_POST['guardaroferta'])) {
    ...
    $sql = "INSERT INTO trabajos_transportes (nombre_trabajo, ubicacion, detalle_trabajo, fecha_inicio, fecha_termino, valor_pagar, hora_inicio, hora_fin, capacidad_minima, imagen_referencia, rut_contratista) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    if ($stmt) {
        ...
        $stmt->bind_param("sssssssssss", $nombre, $ubicacion, $detalletrabajo, $fecha, $duracion, $valorpagar, $inicio, $termino, $capacidad, $img, $runcontratista);
